...
# RUN git clone https://github.com/LinusU/musl.git && cd musl && git checkout b6d60256
RUN git clone https://github.com/fluencelabs/musl.git && cd musl && git checkout 0ec2c066
